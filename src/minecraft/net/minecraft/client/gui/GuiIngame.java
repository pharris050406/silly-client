...
//        //TODO silly overlay
        ...
        if(GameSettings.quickPlace) {
        	this.mc.fontRendererObj.drawString("quick place: ON", 4.5, var4-14.5, 0x00000);
        	this.mc.fontRendererObj.drawString("quick place: ON" , 5, var4-15, 0x09c100);
        }else {
        	this.mc.fontRendererObj.drawString("quick place: OFF", 4.5, var4-14.5, 0x00000);
        	this.mc.fontRendererObj.drawString("quick place: OFF" , 5, var4-15, 0xff0000);
        }
